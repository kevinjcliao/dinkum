...
class DonorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post donors_url, params: { donor: { addressline1: @donor.addressline1, name: @donor.name, postcode: @donor.postcode, state: @donor.state, suburb: @donor.suburb } }
    end
  ...
  test "should update donor" do
    patch donor_url(@donor), params: { donor: { addressline1: @donor.addressline1, name: @donor.name, postcode: @donor.postcode, state: @donor.state, suburb: @donor.suburb } }
